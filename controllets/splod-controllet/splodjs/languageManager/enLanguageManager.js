...
enLanguageManager.prototype.getHelpGuide = function(){
	...
	boxesObj.content.push('<b>The results table tab</b> shows you the results of the user query in tabular format. You can hide some fields or sort them. You can see a results preview by flying over the badge.<img width="100%" src="./splodjs/img/en_resultsTable.png"/>');
